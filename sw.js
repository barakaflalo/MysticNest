...
const SHELL='mysticnest-shell-v9';
const ART='mysticnest-deck-'+MYSTIC_DECK.version;
const CORE=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./privacy_policy.html','./tarot.css','./tarot.js','./card-details.js','./dreams.js','./dream-library.js','./dream-engine.js','./offline.js','./deck-manifest.js'];
